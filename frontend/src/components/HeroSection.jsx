...
const HeroSection = () => {
  return (
    ...
    {/* MAIN HERO TEXT */}
      ...
      <div className="w-[35rem] h-[17.9rem] bg-bgYellow mx-auto mt-16 rounded-t-full">
      <img src={demo_man} alt="" className="mx-auto -translate-y-[4.6rem] hover:scale-105  transition-all duration-300 "/>
      </div>
    </div >
  )
} 
